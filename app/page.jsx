  ...
  <section className="mb-32">
    <div className="text-[#101010] font-bold flex flex-col items-center text-center mb-16">
      ...
      <p className="text-xl max-w-5xl">
        H&H ENGINEERING PROVIDES QUALITY AND COMPREHENSIVE SERVICES FOR COMMERCIAL
        AND RESIDENTIAL BUILDING MECHANICAL, ELECTRICAL AND PLUMBING SYSTEMS AT
        AFFORDABLE RATES. WHETHER YOU’RE AN ARCHITECT DESIGNING A NEW BUILDING, OR
        YOU’RE A MUNICIPALITY LOOKING TO UPDATE YOUR CURRENT FACILITIES, H&H’S TEAM
        OF EXPERIENCED WILL MAXIMIZE YOUR PROJECT COST, PROVIDING YOU WITH
        EFFICIENT, ATTRACTIVE SYSTEMS.
      </p>
    </div>
    ...
    <div className="flex flex-col-reverse md:flex-row gap-6">
      <div className="md:flex-[0_0_55%]">
        <h3 className="text-[#101010] text-3xl mb-5 font-bold">OVERVIEW</h3>

        <div>
          <p className="mb-5">
            WE ARE A CLIENT-ORIENTED CONTRACTING COMPANY AND FOLLOWING COMPLETION
            OF THE PROJECT. THROUGH OUR OPERATIONS, WE PROVIDE INTEGRATED SHOP
            DESIGN & BUILD MEP SERVICES, SMOOTH FUNCTIONALITY AND EFFICIENCY FROM
            START TO FINISH. FROM MECHANICAL, ELECTRICAL AND PLUMBING (MEP), H&H
            POWER CONTINUES TO BE AT THE HELM, DRIVING THE MARKET FORWARD THROUGH
            OUR PEOPLE, PASSION AND INNOVATION.
          </p>
          <p>
            ...
            INSTALLATIONS INCLUSIVE OF SHOP DESIGN. THE COMPANY SPECIALIZES IN
